...
- [x] Add multi-sheet schematic/project support — 2026-08-26
...
- [x] More ERC checks: cross-sheet global label conflicts, power-pin conflicts, missing footprint
  ...
  - [x] Cross-sheet global label conflicts closed by the multi-sheet iteration — `js/erc.js` exposes `CROSS_SHEET_LABEL_CONFLICT` and `CROSS_SHEET_POWER_CONFLICT`, `test/test_project_connectivity.js` covers both, and the schematic ERC panel runs `runProjectERC` and switches sheets when a result is selected — 2026-08-26
